    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications', models.ManyToManyField(related_name='related_room', to='schedule.Application', verbose_name='Приложения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedule.organization', verbose_name='Организация')),
                ('responsible', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedule.staffer', verbose_name='Ответственный сотрудник')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.event', verbose_name='Мероприятие')),
                ('room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schedule.room', verbose_name='Место проведения')),
            ],
        ),
        migrations.AddField(
            model_name='application',
            name='responsible',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schedule.staffer', verbose_name='Ответственный сотрудник'),
        ),
    ]
